  ...
  return (
    <div>
      <div className='flex justify-center items-center space-x-2'>
        ...
        <h3
        className="text-2xl md:text-2xl xl:text-4xl font-semibold
        tracking-tight mb-12"
        >
        <span className="capitalize">Bring creative projects to life on</span>
        <br />
        <span className="uppercase text-green-600">ENDORSE</span>
        </h3>
        <div className="flex justify-center items-center space-x-2">
          <button
          type="button"
      ...
      <div className='py-24 px-6 w-1/3'>
          <img className=' resize:both object-cover h-15 w-15' src={require('../resources/i1.png')} />
      </div>
      </div>
